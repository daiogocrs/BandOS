...
export function Configuracoes() {
  ...
  // Controle das abas: 'perfil' ou 'banda'
  ...
  // Submit da Edição de Nome do Usuário
  ...
  // Submit da Edição Cadastral da Banda
  async function handleSalvarBanda(e: React.FormEvent) {
    ...
    try {
      ...
      // CRUCIAL: Atualiza o estado global para mudar o nome no seletor e na Sidebar
  ...
  // Submit da Alteração Segura de Senha
  async function handleAlterarSenha(e: React.FormEvent) {
    e.preventDefault()
    setMensagemSucesso('')
    setErro('')

    // Validações básicas no Frontend antes de gastar processamento de rede
